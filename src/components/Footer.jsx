...
const Footer = () => {
  motion;
  return (
    <div className="flex w-full h-screen gap-5 p-20 text-white bg-black font-foundersGrotesk">
      <div className="flex flex-col justify-between w-1/2 h-full font-foundersGrotesk">
      ...
      <div className="w-1/2">
        ...
        <div className="mt-20 dets font-neueMontreal">
